			...
			myMove=movesAvail.peek();
				...
				if(Alpha >= Beta)
				{
					...
					this.log = (current.endNode==null)? 
							this.log+"\n"+"root,"+depth+","+
							((current.score==99999)? "Infinity" : ((current.score==-99999)?"-Infinity":current.score)) +","+
							((current.Alpha==99999)? "Infinity" : ((current.Alpha==-99999)?"-Infinity":current.Alpha))+","+
							((current.Beta==99999)? "Infinity" : ((current.Beta==-99999)?"-Infinity":current.Beta)):
							this.log+"\n"+((char)(current.endNode[1]+97))+(current.endNode[0]+1)+","+depth+","+
							((current.score==99999)? "Infinity" : ((current.score==-99999)?"-Infinity":current.score))+","+
							((current.Alpha==99999)? "Infinity" : ((current.Alpha==-99999)?"-Infinity":current.Alpha))+","+
							((current.Beta==99999)? "Infinity" : ((current.Beta==-99999)?"-Infinity":current.Beta));
